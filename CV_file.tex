...
\CVItem{\hspace{-5mm}\mbox{2021--Ongoing}}{\textbf{Student Mentor}, Lehigh Plasma Control Group, Lehigh University, Bethlehem, PA \begin{itemize}
  \item Guided junior researchers in developing simulation frameworks integrating physics-based and neural network surrogate models for dynamic modeling and predictive analysis.
\item Mentored junior researchers in the design and implementation of model-based and data-driven control strategies.
\item Supported preparation and delivery of findings at peer-reviewed conferences.
\end{itemize}}

\CVItem{\hspace{-5mm}\mbox{2018--2021}}{\textbf{Peer Tutor}, Center for Career \& Professional Development, Lehigh University, Bethlehem, PA \begin{itemize}
...
\CVItem{2018--2021}{\textbf{Designer}, Lehigh University Baja SAE \begin{itemize}
\item Designed and validated the rear hub assembly for a competition off-road vehicle, iterating on geometry in SolidWorks to meet structural requirements.
\item Verified design integrity through FEA analysis, confirming the component met load-bearing specifications prior to fabrication.
\item Contributed to vehicle testing across varied terrain, evaluating performance against competition requirements.
\end{itemize}}
% ---------------------------------------------------------
